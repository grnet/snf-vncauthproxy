#  -*- coding: utf-8 -*-
#
# snf-vncauthproxy documentation build configuration file, created by
...
html_title = 'snf-vncauthproxy' + version
...
htmlhelp_basename = 'snf-vncauthproxydoc'
...
latex_documents = [
  ('index', 'snf-vncauthproxy.tex', u'snf-vncauthproxy Documentation',
...
man_pages = [
    ('index', 'snf-vncauthproxy', u'snf-vncauthproxy Documentation',
...
texinfo_documents = [
  ('index', 'snf-vncauthproxy', u'snf-vncauthproxy Documentation',
   u'Synnefo Development', 'snf-vncauthproxy', 'One line description of project.',
   'Miscellaneous'),
]
